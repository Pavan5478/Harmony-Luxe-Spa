      ...
      <div className="flex items-center justify-between gap-2">
        ...
        {primaryCta && (
          <Link
            ...
            prefetch
            className="inline-flex items-center rounded-full border border-border bg-background px-2.5 py-1 text-[11px] font-medium text-primary hover:bg-card hover:no-underline"
          >
            {ctaLabel}
          </Link>
        )}
