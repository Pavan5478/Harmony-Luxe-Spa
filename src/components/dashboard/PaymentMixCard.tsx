      ...
      {pmTotalAmount <= 0 ? (
        ...
        <>
          <div className="mt-4 min-w-0">
            ...
            <div className="mt-2 flex flex-col gap-1 text-[10px] text-muted sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="mt-4 space-y-2 text-[11px] text-muted">
            {items.map((it) => {
              ...
              return (
                <div
                  key={it.key}
                  className="flex min-w-0 flex-col gap-2 rounded-xl bg-background/60 px-3 py-2 sm:flex-row sm:items-center sm:justify-between"
                >
                  <div className="flex min-w-0 items-center gap-2">
                    <span className={`h-2.5 w-2.5 shrink-0 rounded-full ${it.cls}`} />
                    <span className="min-w-0 truncate font-medium text-foreground">
                      {it.label}
                    </span>
                  </div>
